...
//functions to clear all previous content in the container.
        ...
        if (counter==3){
          ...
          for (var indexforcategory=0;indexforcategory<information.articles.length;indexforcategory++){
            ...
            var source=information.articles[indexforcategory].source.name;
...
//setting and styling article link
          ...
          paragraphfordate.setAttribute("style", "font-family:Verdana; color:darkblue; font-size:10px; font-weight:bold;");
            ...
            paragraphfordate.innerHTML="Published at: " +date + "," + " "+ "Source: " + source;
            paragraphfordate.setAttribute("style", "font-family:Verdana; color:darkblue; font-size:10px; font-weight:bold;");
          }



          var paragraphtomixcolor = paragraphfordate;
          var str = paragraphtomixcolor.innerHTML;
          var oldText="";
          var newText = "";
          var indexofsource= str.indexOf("Source")
...
//append elements to div id "test".
      ...
      if (page==max&&allblankinputs!=true){
        document.getElementById("nextlink").style.visibility="hidden";
        console.log("First if statement!");

      }
    else if (zeroresultcounter==(selectedcategories.length-numberofblanks)&&(allblankinputs!=true)){
      document.getElementById("nextlink").style.visibility="hidden";
      console.log("secondifstatement!!");

    }

      else if (allblankinputs!=true){
       document.getElementById("nextlink").style.visibility='visible';
      }
