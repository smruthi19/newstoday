...
function loadhomenews(input){
    ...
    var urlfirsthalf="https://gnews.io/api/v4/top-headlines?";
    var urlsecondhalf="topic=" +input+ "&token=c3d778f78051de561ad0e0d91793aee8";
...
function loadlatestnews(){
  ...
  var url1="https://gnews.io/api/v4/top-headlines?topic=technology&token=c3d778f78051de561ad0e0d91793aee8";
  var url2="https://gnews.io/api/v4/top-headlines?topic=sports&token=c3d778f78051de561ad0e0d91793aee8";
  var url3="https://gnews.io/api/v4/top-headlines?topic=entertainment&token=c3d778f78051de561ad0e0d91793aee8";
...
//store url for API request based on user's selected category.
        var urlfirsthalf="https://gnews.io/api/v4/top-headlines?"
        categoryinput=categoryinput.toLowerCase();
        var urlsecondhalf= "q=" + myinput + "&topic=" + categoryinput + "&token=c3d778f78051de561ad0e0d91793aee8";
        var url=urlfirsthalf+urlsecondhalf;
         console.log("url"+url);
        var title;
        //API Request
